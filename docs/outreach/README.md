...
| **"Runs on a 2019 Model 3 / MCU 2"**                              | **Do not say this.** Both MCU rows in [tesla-notes.md](../tesla-notes.md) are still `_pending_`. Real car sessions happened; nobody recorded which car. Say "a real Tesla screen" until a row says otherwise |
